...
🚀 600 tools, interactive interface, instant copy, and clear explanations. All in one powerful app.

Content of CLI folder: 
...
burp.txt
Burpsuite.txt
burpsuite_filters.txt
Caldera.txt
calibrate_hackrf.txt
capstone.txt
cassandra.txt
certipy.txt
cewl.txt
...
proxmox_ve.txt
pspy.txt
ptrace-based-tools.txt
pv.txt
pwncat.txt
pwngdb.txt
pwntools.txt
qspectrumanalyzer.txt
r2pipe.txt
rabbitmqctl.txt
radamsa.txt
radare2_r2.txt
